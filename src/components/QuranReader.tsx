...
import QuranReaderTraditionalHeader from '@/components/QuranReaderTraditionalHeader';
import QuranReaderTraditionalContent from '@/components/QuranReaderTraditionalContent';
