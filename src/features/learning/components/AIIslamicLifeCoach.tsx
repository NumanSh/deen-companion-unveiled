...
const AIIslamicLifeCoach = () => {
  ...
  const [coaching, setCoaching] = useState<IslamicCoaching | null>(null);
  ...
  const getGuidance = async () => {
    ...
    const mockCoaching: IslamicCoaching = {
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 p-4 rounded-lg border border-amber-200 dark:border-amber-700">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  {coaching.quranVerses.map((item: QuranVerse, index: number) => (
