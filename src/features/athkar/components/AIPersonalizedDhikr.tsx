...
const AIPersonalizedDhikr = () => {
  ...
  const generatePersonalizedDhikr = useCallback(async (mood: string) => {
    setIsLoading(true);
    
    // Simulate AI analysis
    await new Promise(resolve => setTimeout(resolve, 1500));

    const dhikrDatabase: Record<string, DhikrItem> = {
      peaceful: {
    ...
    setCurrentDhikr(dhikrDatabase[mood]);
    setCount(0);
    setProgress(0);
    setIsLoading(false);
