...
const translations = {
  ar: {
    ...
    // New User Welcome translations
    'welcome-islamic-journey': 'مرحباً برحلتك الإسلامية! 🌙',
    'assalamu-alaikum-start-journey': 'السلام عليكم! لنبدأ رحلتك الروحية معنا.',
    'app-help-track-prayers': 'سيساعدك هذا التطبيق على تتبع صلواتك وقراءة القرآن وبناء العادات الإسلامية الجيدة.',
    'daily-islamic-challenges-title': 'التحديات الإسلامية اليومية 🎯',
    'complete-daily-challenges-strengthen': 'أكمل التحديات اليومية لتقوية إيمانك.',
    'start-simple-challenges': 'ابدأ بتحديات بسيطة مثل قراءة سورة الفاتحة أو قول الذكر ١٠ مرات.',
    'achievement-system-title': 'نظام الإنجازات 🏆',
    'earn-achievements-progress': 'احصل على إنجازات بينما تتقدم في رحلتك الإسلامية.',
    'unlock-badges-consistency': 'افتح شارات للاستمرارية في الصلاة وقراءة القرآن والمزيد من الأنشطة الإسلامية.',
    'islamic-milestones-title': 'المعالم الإسلامية 📖',
    'track-progress-phases': 'تتبع تقدمك عبر مراحل مختلفة من التعلم الإسلامي.',
    'progress-foundation-advanced': 'تقدم من الأساسيات إلى المستويات المتقدمة في معرفتك وممارستك الإسلامية.',
    'welcome-celebration': 'مرحباً! 🎉',
    'islamic-journey-starts-now': 'رحلتك الإسلامية تبدأ الآن. بارك الله في جهودك!',
    'data-reset-title': 'تم إعادة تعيين البيانات! 🔄',
    'progress-reset-fresh': 'تم إعادة تعيين تقدمك. بداية جديدة!',
    'new-user-experience': 'تجربة المستخدم الجديد',
    'want-start-fresh': 'تريد أن تبدأ من جديد؟ أعد تعيين تقدمك وابدأ مرة أخرى.',
    'start-fresh': 'ابدأ من جديد',
    'start-journey': 'ابدأ الرحلة',
    'returning-reset-data': 'أنا عائد - فقط أعد تعيين بياناتي',
  },
  en: {
    // Navigation
    dashboard: 'Dashboard',
    ...
    // New User Welcome translations
    'welcome-islamic-journey': 'Welcome to Your Islamic Journey! 🌙',
    'assalamu-alaikum-start-journey': 'Assalamu Alaikum! Let\'s start your spiritual journey with us.',
    'app-help-track-prayers': 'This app will help you track your prayers, read Quran, and build good Islamic habits.',
    'daily-islamic-challenges-title': 'Daily Islamic Challenges 🎯',
    'complete-daily-challenges-strengthen': 'Complete daily challenges to strengthen your faith.',
    'start-simple-challenges': 'Start with simple challenges like reading Surah Al-Fatihah or saying Dhikr 10 times.',
    'achievement-system-title': 'Achievement System 🏆',
    'earn-achievements-progress': 'Earn achievements as you progress in your Islamic journey.',
    'unlock-badges-consistency': 'Unlock badges for prayer consistency, Quran reading, and more Islamic activities.',
    'islamic-milestones-title': 'Islamic Milestones 📖',
    'track-progress-phases': 'Track your progress through different phases of Islamic learning.',
    'progress-foundation-advanced': 'Progress from Foundation to Advanced levels in your Islamic knowledge and practice.',
    'welcome-celebration': 'Welcome! 🎉',
    'islamic-journey-starts-now': 'Your Islamic journey starts now. May Allah bless your efforts!',
    'data-reset-title': 'Data Reset! 🔄',
    'progress-reset-fresh': 'Your progress has been reset. Starting fresh!',
    'new-user-experience': 'New User Experience',
    'want-start-fresh': 'Want to start fresh? Reset your progress and begin again.',
    'start-fresh': 'Start Fresh',
    'start-journey': 'Start Journey',
    'returning-reset-data': 'I\'m returning - just reset my data',
  }
};
